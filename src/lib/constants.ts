...
export const DAO_TOKENS = [
  ...
  },
  {
    ...
    governance: {
      ...
      governorAddress: "0x323A76393544d5ecca80cd6ef2A560C6a395b7E3" as `0x${string}`,
      governorType: "ozGovernor" as const,
    },
  },
  {
    name: "Uniswap",
    ...
    governance: {
      type: "governor" as const,
      governorAddress: "0x408ED6354d4973f66138C91495F2f2FCbd8724C3" as `0x${string}`,
      governorType: "governorBravo" as const,
    },
  },
  {
    name: "Arbitrum",
    ...
    governance: {
      type: "governor" as const,
      governorAddress: "0x789fC99093B09aD01C34DC7251D0C89ce743e5a4" as `0x${string}`,
      governorType: "ozGovernor" as const,
    },
  },
  {
    ...
    governance: {
      type: "governor" as const,
      governorAddress: "0xcDF27F107725988f2261Ce2256bDfCdE8B382B10" as `0x${string}`,
      governorType: "ozGovernor" as const,
    },
  },
] as const;
