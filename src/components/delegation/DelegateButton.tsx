      ...
      <div className="mt-4 flex gap-3">
        {isDelegatedToSenate ? (
          <button
            ...
            className="flex-1 py-2.5 rounded-lg font-semibold transition-colors bg-red-900/30 text-red-300 border border-red-800 hover:bg-red-900/50 disabled:opacity-50"
          >
            {isPending
              ? "Confirm in wallet..."
              : isConfirming
          ...
          <button
            ...
            className="flex-1 py-2.5 rounded-lg font-semibold transition-colors bg-indigo-600 hover:bg-indigo-500 disabled:bg-gray-700 disabled:text-gray-500"
          >
            {isPending
              ? "Confirm in wallet..."
              : isConfirming
